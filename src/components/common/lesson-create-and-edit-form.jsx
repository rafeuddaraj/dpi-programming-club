...
export default function LessonCreateAndEditForm({
  data,
  onSubmitHandler,
  module,
}) {
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      {module && (
        <div className="text-muted-foreground">
          {data ? "Updating" : "Adding"} lesson to module:{" "}
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <Card className="max-w-2xl mx-auto">
            <CardHeader>
              ...
              <CardDescription>
                {data ? "Update" : "Create"} a new lesson for your module.
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between">
              <Button
                ...
                onClick={() =>
                  moduleId && module
                    ? router.push(
                        `/dashboard/workshops/${module.workshopId}?tab=modules`
                      )
