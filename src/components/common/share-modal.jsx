    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Share this with your friends, colleagues, and anyone who can benefit
            from it. Since we're building this for networking, make sure to
            connect with those who will make the most out of it and grow
            together!
          </DialogDescription>
        </DialogHeader>
