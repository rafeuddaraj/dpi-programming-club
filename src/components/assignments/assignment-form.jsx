            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-2xl">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormDescription>Detailed instructions for the assignment.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    ...
                                    <SelectContent>
                                        <SelectItem disabled={true} value="COURSE">Course</SelectItem>
                                        <SelectItem value="WORKSHOP">Workshop</SelectItem>
                                        <SelectItem disabled={true} value="PROJECT">Project</SelectItem>
                                    </SelectContent>
                                </Select>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormDescription>Maximum marks for this assignment.</FormDescription>
                                <FormMessage />
                            </FormItem>
                        )}
                    />
                ...
                <div className="flex gap-4">
                    ...
                    <Button type="submit" disabled={isSubmitting}>
                        {isSubmitting ? <><Loader2 className="animate-spin" /> Saving...</> : assignment ? "Update Assignment" : "Create Assignment"}
                    </Button>
                </div>
            </form>
        </Form>
