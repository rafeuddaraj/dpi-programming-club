...
const formSchema = z.object({
    name: z.string().min(3, { message: `Notice name must be at least 3 characters"` }),
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input placeholder={`https://document.com/notice.pdf`} {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <div className="my-4">
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            <Switch checked={form.watch("status")} onCheckedChange={(check => form.setValue("status", check))} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                        ...
                        <div className="flex justify-end gap-4 pt-4">
                            ...
                            <Button type="submit" disabled={form.formState.isSubmitting}>
                                {form.formState.isSubmitting ? <><Loader2 className="animate-spin" /> Saving...</> : notice ? "Update Notice" : "Create Notice"}
                            </Button>
                        </div>
                    </form>
                </Form>
