                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                            ...
                            <span className="text-sm text-muted-foreground">Created: {formatDate(assignment.createdAt)}</span>
                        </div>
                    </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground break-all">{assignment.lessonId}</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
