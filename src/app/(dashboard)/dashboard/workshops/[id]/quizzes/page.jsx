  ...
  return (
    <div className="container mx-auto py-10">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link
          href={`/dashboard/workshops/${params?.id}/quizzes/${searchParams?.lessonId}/create`}
        >
          <Button>
      ...
      {quizzes.length === 0 ? (
        <div className="text-center py-10">
          ...
          <Link
            href={`/dashboard/workshop/${params?.id}/quizzes/create?lessonId=${searchParams?.lessonId}`}
          >
