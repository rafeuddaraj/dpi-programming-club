                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead className="hidden md:table-cell">Session & Shift</TableHead>
                            ...
                            {students.length === 0 ? (
                                ...
                                students.map((student) => (
                                    <TableRow key={student.id} className="group">
                                        ...
                                        <TableCell className="hidden md:table-cell">{student.registrationNo}</TableCell>
                                        <TableCell className="hidden md:table-cell">
                                            {student.session} ({student.shift})
                                        </TableCell>
                                        <TableCell className="hidden lg:table-cell">{student.email}</TableCell>
                                        <TableCell className="hidden sm:table-cell">{student.department}</TableCell>
